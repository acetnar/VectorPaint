...
public class Triangle extends Shape {
    ...
    private Triangle(Triangle.Builder builder){
    ...
    public static class Builder{
        ...
        public Triangle.Builder setFillColor(String  fillColor) {
            this.fillColor = Color.valueOf(fillColor);
            return this;
        }

        public Triangle.Builder setStrokeColor(String  strokeColor) {
