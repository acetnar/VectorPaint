...
public class Ellipse extends Shape {
    ...
    public static class Builder{
        ...
        public Ellipse.Builder setX1(double x1) {
            this.x1 = x1;
            return this;
        }

        public Ellipse.Builder setY1(double y1) {
            this.y1 = y1;
            return this;
        }

        public Ellipse.Builder setX2(double x2) {
            this.x2 = x2;
            return this;
        }

        public Ellipse.Builder setY2(double y2) {
            this.y2 = y2;
            return this;
        }

        public Ellipse.Builder setFillColor(String  fillColor) {
            this.fillColor = Color.valueOf(fillColor);
            return this;
        }

        public Ellipse.Builder setStrokeColor(String  strokeColor) {
